                ...
                class RouteAttributes:
                    ...
                    class InterfaceAttributes:
                        ...
                        def build_config(self, apply=True, attributes=None, unconfig=False, **kwargs):
                            ...
                            if attributes.value('af') is not None:
                                af = 'ip' if attributes.value('af').value == 'ipv4' else 'ipv6'
                                join_all = "{} route".format(af)

                            if attributes.value('vrf') is not None and 'default' not in attributes.value('vrf'):
                                join_all += " vrf {}".format(attributes.value('vrf'))

                            if attributes.value('route') is not None:
                            ...
                            if attributes.value('interface') is not None:
                                join_all += " {}".format(attributes.value('interface'))

                            if attributes.value('if_nexthop') is not None:
                                join_all += ' {}'.format(attributes.value('if_nexthop'))

                            if attributes.value('if_srv6_policy') is not None:
                    ...
                    class NextHopAttributes:
                        ...
                        def build_config(self, apply=True, attributes=None, unconfig=False, **kwargs):
                            ...
                            if attributes.value('nexthop') is not None:
