...
class Srv6(DeviceFeature):
    ...
    # set mtu <1280-4000>
    mtu = managedattribute(name='mtu', default=None, type=(None, managedattribute.test_istype(int)), doc='set mtu <1280-4000>')

    # set mss <800-3960|off|auto>
    mss = managedattribute(name='mss', default=None, type=(None, managedattribute.test_istype((int, str))), doc='set mss <800-3960|off|auto>')

    # fragment <post|pre>
    fragment = managedattribute(name='fragment', default=None, type=(None, managedattribute.test_istype(str)), doc='fragment <post|pre>')

    # propagate-tos {enable|disable [<0-255>]}
    propagate_tos = managedattribute(name='propagate_tos', default=None, type=(None, managedattribute.test_istype((int, str))), doc='propagate-tos {enable|disable [<0-255>]}')
