...
class L3vpn(DeviceFeature):
    ...
    bgp_asn = managedattribute(name='bgp_asn', default=None, type=(None, managedattribute.test_istype(int), managedattribute.test_istype(str)), doc='bgp as number')

    # interface level attribute

    ipv4_address = managedattribute(name='ipv4_address', default=None, type=(None, managedattribute.test_istype(str)), doc='ipv4 address')

    ipv6_address = managedattribute(name='ipv6_address', default=None, type=(None, managedattribute.test_istype(str)), doc='ipv6 address')

    # address-family <af> level attribute

    redistribute = managedattribute(name='redistribute', default=None, type=(None, managedattribute.test_istype(str), managedattribute.test_istype(list)), doc='redistribute')
